...
import AiImpactSummaryPresentation from "../../../components/presentational/reports/AiImpactSummaryPresentation";

/**
 * ViewModel for the AI Impact Summary report
 * Processes data related to the overall impact of AI on productivity
 */
const AiImpactSummaryViewModel = ({ reports, filters = {} }) => {
