      ...
      prevRows.map((row) => {
        if (row.id === id) {
          ...
          if (
            ...
            const timeSaved = Math.max(0, estimatedTime - actualTime).toFixed(
              1,
            );
                  ...
                  <ResponsiveTable>
                    ...
                    >
                      ...
                      {rows
                        ...
                        .toFixed(1)}{" "}
                      hrs | Total Time Saved:{" "}
                      {rows
                        .reduce(
                          (sum, row) => sum + (parseFloat(row.timeSaved) || 0),
                          0,
                        )
                        .toFixed(1)}{" "}
                      hrs
                    ...
                    <TableMobile>
                      ...
                      >
                        ...
                        {rows
                          .reduce(
                            (sum, row) =>
                              sum + (parseFloat(row.hoursSaved) || 0),
                            0,
                          )
                          .toFixed(1)}
                      </div>
