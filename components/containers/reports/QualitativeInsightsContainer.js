...
import QualitativeInsightsPresentation from "../../presentational/reports/QualitativeInsightsPresentation";
 ...
 */
const QualitativeInsightsContainer = ({ reports, filters = {} }) => {
  ...
  const extractKeywords = (textArray) => {
    ...
    const stopWords = new Set([
      ...
      'would', 'should', 'could', 'ought', 'i\'m', 'you\'re', 'he\'s',
    ...
    const aiSpecificStopWords = new Set([
      ...
      'copilot', 'github', 'tool', 'tools', 'used', 'using', 'use',
      'helped', 'help', 'helping', 'task', 'tasks'
    ]);
  ...
  const identifyThemes = (textArray) => {
    ...
    const themeCategories = {
      "Code Generation": ["code generation", "generate code", "boilerplate", "scaffolding", "initial code", "skeleton", "template", "starter"],
      "Test Creation": ["test", "testing", "unit test", "test case", "test coverage", "integration test", "automated test"],
      "Bug Fixing": ["bug", "fix", "issue", "problem", "error", "debug", "troubleshoot", "resolve"],
      "Documentation": ["document", "documentation", "comment", "readme", "explain", "explanatory", "description"],
      "Design Patterns": ["pattern", "design pattern", "architecture", "structure", "framework"],
      "Refactoring": ["refactor", "clean", "improve", "optimize", "enhancement", "modernize", "update"],
      "Learning": ["learn", "understand", "learning", "clarify", "explanation", "tutorial", "example"],
      "Code Review": ["review", "feedback", "suggestions", "improvement", "critique", "assessment"],
      "API Integration": ["api", "integration", "connect", "service", "endpoint", "rest", "graphql", "interface", "websocket"],
      "UI/UX Design": ["ui", "user interface", "ux", "user experience", "design", "layout", "styling", "css"],
      "Database": ["database", "db", "sql", "query", "data model", "schema", "nosql", "orm", "relational"],
      "Performance": ["performance", "speed", "optimization", "fast", "efficient", "bottleneck", "slowdown", "latency"],
      "Security": ["security", "secure", "authentication", "authorization", "encrypt", "protection", "vulnerability"],
      "Deployment": ["deploy", "deployment", "ci/cd", "pipeline", "release", "launch", "production", "hosting"],
      "Prompt Engineering": ["prompt", "instruction", "query", "prompt engineering", "conversation", "chat"],
      "AI Limitations": ["limitation", "limited", "struggle", "wrong", "incorrect", "hallucination", "mistake", "error"]
    };
  ...
  return (
    <QualitativeInsightsPresentation 
...
export default QualitativeInsightsContainer;